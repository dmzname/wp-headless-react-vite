...
/****************************************************************
 "dmz_wp_theme" - functions and definitions
 *! DO NOT DELETE 
 ****************************************************************/
...
if ( get_stylesheet_directory() == get_template_directory() ) {
	...
	define( 'DMZ_THEME_DIR', get_theme_root() . '/dmz_wp_them/dmz_theme' );
	define( 'DMZ_THEME_URL', get_theme_root_uri() . '/dmz_wp_them/dmz_theme' );
	
	//define( 'DMZ_PATH_ASSETS', get_theme_root() . '/dmz_wp_them/assets' );
	//define( 'DMZ_URL_ASSETS', get_theme_root_uri() . '/dmz_wp_them/assets' );
}
